...
/**
 * Created by Maurizio on 11/06/2015.
 */
public final class FFT {
    ...
    private  double[] computeTwiddleFactors(int fftFrameSize,
                                                        int sign) {
    ...
    private void calc(int fftFrameSize, double[] data, int sign,
                                   double[] w) {
    ...
    private void calcF2E(int fftFrameSize, double[] data, int i,
                                      int nstep, double[] w) {
        int jmax = nstep;
    ...
    // complex operators
    private void calcF4F(int fftFrameSize, double[] data, int i,
                                      int nstep, double[] w) {
    ...
    // Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
    // complex operators
    private void calcF4I(int fftFrameSize, double[] data, int i,
                                      int nstep, double[] w) {
        final int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
        // Factor-4 Decomposition
    ...
    // Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
    // complex operators
    private void calcF4FE(int fftFrameSize, double[] data, int i,
                                       int nstep, double[] w) {
        final int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
        // Factor-4 Decomposition
    ...
    // Perform Factor-4 Decomposition with 3 * complex operators and 8 +/-
    // complex operators
    private void calcF4IE(int fftFrameSize, double[] data, int i,
                                 int nstep, double[] w) {
        final int fftFrameSize2 = fftFrameSize << 1; // 2*fftFrameSize;
        // Factor-4 Decomposition
